...
namespace Measure
{
    ...
    public class Cst
    {
        ...
        public struct dPoint//点结构 
        {
            ...
            public static dPoint operator *(dPoint a, double b)
            {
        ...
        public class Cam_Param //相机参数
        {
            ...
            public double LineTolerance = 0.5;
        }
        ...
        public struct Struct_Robust
        {
            public int RobustSampleNum;
            public int MaxRobustCount;
        }
        public struct Struct_EdgeMultiplePoint // 边界多点
        {
            ...
            public int Dir;                    // 搜索方向 1:X, 2:Y, 3:X-Rising, 4:X-Falling, 5:Y-Rising, 6:Y-Falling,
            public bool PrintMultiplePoint;        // 是否打印多个点
            public double IgnoreLength, IgnoreLength1, IgnoreLength2;
            public Struct_Line Line;
            public dPoint FirstEndPoint;
            public dPoint SecondEndPoint;
            public Struct_Robust Robust;
        }
        ...
        public struct Struct_VParam
        {
            ...
            public dPoint TopRef, BottomRef, AvgRef;
            public dPoint TopLeft, BottomLeft;
            public int ThresholdStd, ThresholdCell;
        }
        public struct Struct_DataInfo
        {
            ...
            public double Value
            {
                ...
                {
                    Original = value;
                    if (double.IsInfinity(Original) || double.IsNaN(Original)) Original = NaN;
                }
            }
