...
{
    public class VSRightCell : VSBase
    {
        [DllImport("Vision1.dll", EntryPoint = "Vision_InitMil")]
        public static extern short Vision_InitMil(int iWidth, int iHeight, int iBand);

        [DllImport("Vision1.dll", EntryPoint = "Vision_SetHwnd")]
        public static extern void Vision_SetHwnd(IntPtr hWnd);

        [DllImport("Vision1.dll", EntryPoint = "Vision_SetHwndRelease")]
        public static extern void Vision_SetHwndRelease();

        [DllImport("Vision1.dll", EntryPoint = "Vision_Init")]
        public static extern short Vision_Init(IntPtr hWnd, int iWidth, int iHeight, int iBand);

        [DllImport("Vision1.dll", EntryPoint = "Vision_UnInit")]
        public static extern void Vision_UnInit();

        [DllImport("Vision1.dll", EntryPoint = "Vision_CKCopy")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_DrawArc")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_DrawCross")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_DrawLine")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_DrawText")]
        public static extern void Vision_DrawText(int x, int y, int FontSize, int Color, string str);

        [DllImport("Vision1.dll", EntryPoint = "Vision_MarkClean")]
        public static extern void Vision_MarkClean();

        [DllImport("Vision1.dll", EntryPoint = "Vision_ShowRect")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_Binary")]
        public static extern void Vision_Binary(int Value);


        //BLOB
        [DllImport("Vision1.dll", EntryPoint = "Vision_FindBlobSinglePoint")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_FindBlobMultiplePoint")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_GetBlobMultiplePointResult")]
        ...
        //PAT
        [DllImport("Vision1.dll", EntryPoint = "Vision_SavePatTemp")]
        public static extern void Vision_SavePatTemp(string Path, string TempName);//Path路径 TempName名称如“SS”

        [DllImport("Vision1.dll", EntryPoint = "Vision_LoadPatTemp")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_FindPat")]
        ...
        //StepMark 
        [DllImport("Vision1.dll", EntryPoint = "Vision_FindStepMark")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_FindStepMarkMultiplePoint")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_GetStepMarkMultiplePoint")]
        ...
        //Edge 
        [DllImport("Vision1.dll", EntryPoint = "Vision_FindEdge")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_FindEdgeMultiplePoint")]
        ...
        [DllImport("Vision1.dll", EntryPoint = "Vision_GetEdgeMultiplePoint")]
