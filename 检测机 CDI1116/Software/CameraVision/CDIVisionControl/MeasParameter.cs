...
namespace CDIVisionControl
{
    public class Cst
    {
        ...
        public struct struct_ProductParam
        {
            public double Width;
            public double Lenght;
            public double AlTabDis;
            public double NiTabDis;
            public double PoleWidth;

            public double ModelHX;
            public double ModelHY;
            public double ModelVX;
            public double ModelVY;

            public bool bUseMainParam;
            public bool bPrintMultiplePoint;
            public bool bMultiplePoint;
        }
