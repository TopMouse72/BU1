...
namespace GigEApi
{
    public class GigeApi
    {
        ...
        */
        ...
        [DllImport(SVGigE_DLL64, EntryPoint = "Camera_setLensFocalLenght", CallingConvention = CallingConvention.Cdecl)] 
        private static extern unsafe
        SVSGigeApiReturn
        Camera_setLensFocalLenght64(void* hCamera, uint FocalLenght);

        [DllImport(SVGigE_DLL, EntryPoint = "Camera_setLensFocalLenght", CallingConvention = CallingConvention.Cdecl)] 
        private static extern unsafe
        SVSGigeApiReturn
        Camera_setLensFocalLenght32(void* hCamera, uint FocalLenght);
        public static unsafe
        SVSGigeApiReturn
        Camera_setLensFocalLenght(void* hCamera, uint FocalLenght)
        {
            return IntPtr.Size == 8 /* 64bit */ ? Camera_setLensFocalLenght64(hCamera, FocalLenght) : Camera_setLensFocalLenght32(hCamera, FocalLenght);
        }



        [DllImport(SVGigE_DLL64, EntryPoint = "Camera_getLensFocalLenght", CallingConvention = CallingConvention.Cdecl)] 
        private static extern unsafe
        SVSGigeApiReturn
        Camera_getLensFocalLenght64(void* hCamera, uint* FocalLenght);

        [DllImport(SVGigE_DLL, EntryPoint = "Camera_getLensFocalLenght", CallingConvention = CallingConvention.Cdecl)] 
        private static extern unsafe
        SVSGigeApiReturn
        Camera_getLensFocalLenght32(void* hCamera, uint* FocalLenght);
        public static unsafe
        SVSGigeApiReturn
        Camera_getLensFocalLenght(void* hCamera, uint* FocalLenght)
        {
            return IntPtr.Size == 8 /* 64bit */ ? Camera_getLensFocalLenght64(hCamera, FocalLenght) : Camera_getLensFocalLenght32(hCamera, FocalLenght);
        }


        [DllImport(SVGigE_DLL64, EntryPoint = "Camera_getLensFocalLenghtMin", CallingConvention = CallingConvention.Cdecl)] 
        private static extern unsafe
        SVSGigeApiReturn
        Camera_getLensFocalLenghtMin64(void* hCamera, uint* FocalLenghtMin);

        [DllImport(SVGigE_DLL, EntryPoint = "Camera_getLensFocalLenghtMin", CallingConvention = CallingConvention.Cdecl)] 
        private static extern unsafe
        SVSGigeApiReturn
        Camera_getLensFocalLenghtMin32(void* hCamera, uint* FocalLenghtMin);
        public static unsafe
        SVSGigeApiReturn
        Camera_getLensFocalLenghtMin(void* hCamera, uint* FocalLenghtMin)
        {
            return IntPtr.Size == 8 /* 64bit */ ? Camera_getLensFocalLenghtMin64(hCamera, FocalLenghtMin) : Camera_getLensFocalLenghtMin32(hCamera, FocalLenghtMin);
        }



        [DllImport(SVGigE_DLL64, EntryPoint = "Camera_getLensFocalLenghtMax", CallingConvention = CallingConvention.Cdecl)] 
        private static extern unsafe
        SVSGigeApiReturn
        Camera_getLensFocalLenghtMax64(void* hCamera, uint* FocalLenghtMax);

        [DllImport(SVGigE_DLL, EntryPoint = "Camera_getLensFocalLenghtMax", CallingConvention = CallingConvention.Cdecl)] 
        private static extern unsafe
        SVSGigeApiReturn
        Camera_getLensFocalLenghtMax32(void* hCamera, uint* FocalLenghtMax);
        public static unsafe
        SVSGigeApiReturn
        Camera_getLensFocalLenghtMax(void* hCamera, uint* FocalLenghtMax)
        {
            return IntPtr.Size == 8 /* 64bit */ ? Camera_getLensFocalLenghtMax64(hCamera, FocalLenghtMax) : Camera_getLensFocalLenghtMax32(hCamera, FocalLenghtMax);
        }
        ...
        */
                                ...
                                IntPtr Context)
        {
            ...
            void* cam = hCamera.ToPointer();
            void* stream = hStreamingChannel.ToPointer();
            rval = StreamingChannel_createEx(stream,
                                            hCameraContainer,
                                            cam,
                                            BufferCount,
                                            PacketResendTimeout,
        ...
        */
        ...
        /** setLensFocalLenght.
        *
        *  A provided focal lenght  will be transferred to lens.
        *  @see Camera_isCameraFeature()  
        *  @see CameraContainer_getCamera()  
        *  @param hCamera a camera handle received from CameraContainer_getCamera()
        *  @param FocalLenght the focal lenght to be assigned to the Lens (granularity: 1/10 mm, ex. 350 corresponds to 35 mm). 
        *  @	return success or error code
        */
        public unsafe
        SVSGigeApiReturn
        Gige_Camera_setLensFocalLenght(IntPtr hCamera, uint FocalLenght)
        {
            void* cam = hCamera.ToPointer();
            return Camera_setLensFocalLenght(cam, FocalLenght);
        }

        /** getLensFocalLenght.
        *  The currently set focal lenght  of the lens will be 	returned.
        *  @see Camera_isCameraFeature() 
        *  @see CameraContainer_getCamera()  
        *  @param hCamera a camera handle received from CameraContainer_getCamera()
        *  @param FocalLenght the currently assigned focal lenght (granularity: 1/10 mm, ex. 350 corresponds to 35 mm).
        *  @	return success or error code
        */
        public unsafe
        SVSGigeApiReturn
        Gige_Camera_getLensFocalLenght(IntPtr hCamera, ref uint FocalLenght)
        {
            void* cam = hCamera.ToPointer();
            fixed (uint* p = &FocalLenght)
            {
                return Camera_getLensFocalLenght(cam, p);
            }
        }
        ...
        */
        public unsafe
        SVSGigeApiReturn
        Gige_Camera_getLensFocalLenghtMin(IntPtr hCamera, ref uint FocalLenghtMin)
        {
            void* cam = hCamera.ToPointer();
            fixed (uint* p = &FocalLenghtMin)
            {
                return Camera_getLensFocalLenghtMin(cam, p);
            }
        }
        ...
        */
        public unsafe
        SVSGigeApiReturn
        Gige_Camera_getLensFocalLenghtMax(IntPtr hCamera, ref uint FocalLenghtMax)
        {
            void* cam = hCamera.ToPointer();
            fixed (uint* p = &FocalLenghtMax)
            {
                return Camera_getLensFocalLenghtMax(cam, p);
            }
        }
